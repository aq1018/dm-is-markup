...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README", "README.markdown"]
  s.files = ["Rakefile", "README", "README.markdown", "spec/integration/markup_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "Manifest", "dm-is-markup.gemspec"]
  s.has_rdoc = true
